...
print(len(rawsmcceph) - len(cleansmcceph)) #Checking how many stars were in pre-processing
print(len(rawlmcceph) - len(cleanlmcceph)) #Checking how many stars were in pre-processing
